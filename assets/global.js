...
class VariantSelects extends HTMLElement {
  ...
  filterImgVariant() {
    if (
      ...
      //show only variant of selected option
      document
...
window.onload = function () {
  ...
  if (result) {
    ...
    add_ele.style.color = "red"; // Set the color to red
    ...
    var textNode = document.createTextNode("You have already subscribed!");

    // Append the text node to the 'add_ele' element
    add_ele.appendChild(textNode);

    // Append the 'add_ele' element to the '.newsletter-form' element
    document.querySelector(".newsletter-form-popup").appendChild(add_ele);

    // Add fade-out animation to the 'add_ele' element
    add_ele.animate(
      [
        // Keyframes
    ...
    // Set an interval to continuously check for the presence of 'newsletter-form__message'
    // setInterval(function () {
    //   var element = document.querySelector('.newsletter-form__message');
    //   if (element) {
    //     console.log('newsletter-form__message is present');
    //   }
...
window.addEventListener("load", function () {
  ...
  // Set the input value to the value stored in local storage
  ...
  // Store the input value in local storage when the form is submitted
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  // Check if the input field exists and contains a value
  if (inputField && inputField.value) {
    // The page has not been refreshed, so don't modify the URL
    return;
  }
  ...
  // Split the URL at 'pages/coming-soon'
  var url_parts = live_url.split("https://shonen-supps.myshopify.com/");

  // Get the first part of the URL
  var new_url = url_parts.shift();
